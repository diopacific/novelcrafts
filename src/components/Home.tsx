      ...
      <div className="max-w-4xl w-full z-10 space-y-12 mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-6">
          ...
          >
            ...
            <p className="text-[14.5px] text-slate-600 leading-[1.6] font-medium w-full">장편 연재를 지탱하는 뼈대 구축 단계입니다. 세계관, 캐릭터 등 6가지 최우선(Priority 1) 설정 바이블을 작성합니다.</p>
          </div>
          ...
          >
            ...
            <h3 className="text-[22px] font-bold text-slate-900 mb-3 tracking-tight w-full">집필 공장</h3>
            <p className="text-[14.5px] text-slate-600 leading-[1.6] font-medium w-full">에피소드·감정선 기획, 장면 단위 집필 및 품질 검증, 매끄러운 단락 병합까지 이어지는 6-Stage 엔진을 가동합니다.</p>
          </div>
          ...
          >
            ...
            <h3 className="text-[22px] font-bold text-slate-900 mb-3 tracking-tight w-full">기타</h3>
            <p className="text-[14.5px] text-slate-600 leading-[1.6] font-medium w-full">데이터 로컬 백업 관리, 그리고 회차별 작업물 및 단어 수 등 통계 정보를 확인하는 유틸리티 공간입니다.</p>
          </div>
        </div>
      </div>
    </div>
